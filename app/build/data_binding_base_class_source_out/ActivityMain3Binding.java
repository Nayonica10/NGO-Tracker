...
public final class ActivityMain3Binding implements ViewBinding {
  ...
  private ActivityMain3Binding(@NonNull ConstraintLayout rootView, @NonNull TextView textView,
  ...
  public static ActivityMain3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain3Binding((ConstraintLayout) rootView, textView, textView2);
    }
